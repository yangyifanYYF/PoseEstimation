...
BASE_DIR = '/workspace/code/'
sys.path.append('/workspace/code/GenPose-main/GenPose-main/lib')
from align import align_nocs_to_depth

OBJ_MODEL_DIR = os.path.join(BASE_DIR, 'data/PoseData', 'obj_models')
...
def annotate_camera_train(data_dir):
    ...
    # for img_path in tqdm(camera_train[200856:], initial=200856, total=len(camera_train)):
...
if __name__ == '__main__':
    data_dir = os.path.join(BASE_DIR, 'data/PoseData')
